...
! function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = n, n.create = function(e, t) {
            ...
            return i.y = n.y + ((e.x - n.x) * r + (e.y - n.y) * o), i.x = s, i
        ...
        i.create = function(e, t) {
            ...
            for (var t, n, r, s = i.area(e, !0), a = {
                    x: 0,
                    y: 0
                }, l = 0; l < e.length; l++) r = (l + 1) % e.length, t = o.cross(e[l], e[r]), n = o.mult(o.add(e[l], e[r]), t), a = o.add(a, n);
            return o.div(a, 6 * s)
        }, i.mean = function(e) {
            for (var t = {
                    x: 0,
            ...
            for (var n, i, r = 0, s = 0, a = e, l = 0; l < a.length; l++) i = (l + 1) % a.length, r += (n = Math.abs(o.cross(a[i], a[l]))) * (o.dot(a[i], a[i]) + o.dot(a[i], a[l]) + o.dot(a[l], a[l])), s += n;
            return t / 6 * (r / s)
            ...
            var i, o = e.length,
                r = t.x * n,
                s = t.y * n;
            for (i = 0; i < o; i++) e[i].x += r, e[i].y += s;
            return e
        }, i.rotate = function(e, t, n) {
            if (0 !== t) {
                var i, o, r, s, a = Math.cos(t),
                    l = Math.sin(t),
                    c = n.x,
                    u = n.y,
                    d = e.length;
                for (s = 0; s < d; s++) o = (i = e[s]).x - c, r = i.y - u, i.x = c + (o * a - r * l), i.y = u + (o * l + r * a);
                return e
            }
        }, i.contains = function(e, t) {
            for (var n, i = t.x, o = t.y, r = e.length, s = e[r - 1], a = 0; a < r; a++) {
                if (n = e[a], (i - s.x) * (n.y - s.y) + (o - s.y) * (s.x - n.x) > 0) return !1;
                s = n
            }
            return !0
            ...
            var s, a;
            r = r || i.centre(e);
            for (var l = 0; l < e.length; l++) s = e[l], a = o.sub(s, r), e[l].x = r.x + a.x * t, e[l].y = r.y + a.y * n;
            return e
        }, i.chamfer = function(e, t, n, i, s) {
            t = "number" == typeof t ? [t] : t || [8], n = void 0 !== n ? n : -1, i = i || 2, s = s || 14;
            for (var a = [], l = 0; l < e.length; l++) {
                ...
                if (0 !== p) {
                    var f = o.normalise({
                        ...
                        h = o.normalise(o.mult(o.add(f, v), .5)),
                        g = o.sub(u, o.mult(h, y)),
                        x = n; - 1 === n && (x = 1.75 * Math.pow(p, .32)), (x = r.clamp(x, i, s)) % 2 == 1 && (x += 1);
                    for (var b = Math.acos(o.dot(f, v)) / x, S = 0; S < x; S++) a.push(o.add(o.rotate(m, b * S), g))
                } else a.push(u)
            }
            return a
            ...
            if (s < 3) return null;
            for (t = 0; t < s; t++)
                if (i = (t + 2) % s, o = (e[n = (t + 1) % s].x - e[t].x) * (e[i].y - e[n].y), (o -= (e[n].y - e[t].y) * (e[i].x - e[n].x)) < 0 ? r |= 1 : o > 0 && (r |= 2), 3 === r) return !1;
            return 0 !== r || null
        }, i.hull = function(e) {
            var t, n, i = [],
                r = [];
        ...
        ! function() {
            ...
            var e = function(e, t) {
                ...
                e.render.fillStyle = e.render.fillStyle || n, e.render.strokeStyle = e.render.strokeStyle || s, e.render.lineWidth = e.render.lineWidth || u, e.render.sprite.xOffset += -(e.bounds.min.x - e.position.x) / (e.bounds.max.x - e.bounds.min.x), e.render.sprite.yOffset += -(e.bounds.min.y - e.position.y) / (e.bounds.max.y - e.bounds.min.y)
            };
            i.set = function(e, t, n) {
                ...
                for (var s = 0; s < e.parts.length; s++) {
                    var a = e.parts[s];
                    a.position.x += i.x, a.position.y += i.y, o.translate(a.vertices, i), l.update(a.bounds, a.vertices, e.velocity)
                }
                ...
                for (var s = 0; s < e.parts.length; s++) {
                    var a = e.parts[s];
                    a.angle += i, o.rotate(a.vertices, i, e.position), c.rotate(a.axes, i), l.update(a.bounds, a.vertices, e.velocity), s > 0 && r.rotateAbout(a.position, i, e.position, a.position)
                }
                ...
                i.setAngularVelocity(e, a.sign(i.getAngularVelocity(e)) * t)
            }, i.translate = function(e, t, n) {
                ...
                for (var u = 0; u < e.parts.length; u++) {
                    ...
                    o.scale(d.vertices, t, n, r), d.axes = c.fromVertices(d.vertices), d.area = o.area(d.vertices), i.setMass(d, e.density * d.area), o.translate(d.vertices, {
                        ...
                        x: d.position.x,
                        y: d.position.y
                    }), u > 0 && (s += d.area, a += d.inertia), d.position.x = r.x + (d.position.x - r.x) * t, d.position.y = r.y + (d.position.y - r.y) * n, l.update(d.bounds, d.vertices, e.velocity)
                }
                e.parts.length > 1 && (e.area = s, e.isStatic || (i.setMass(e, e.density * s), i.setInertia(e, a))), e.circleRadius && (t === n ? e.circleRadius *= t : e.circleRadius = null)
                ...
                e.velocity.x = d * u + e.force.x / e.mass * n, e.velocity.y = p * u + e.force.y / e.mass * n, e.positionPrev.x = e.position.x, e.positionPrev.y = e.position.y, e.position.x += e.velocity.x, e.position.y += e.velocity.y, e.deltaTime = t, e.angularVelocity = (e.angle - e.anglePrev) * u * s + e.torque / e.inertia * n, e.anglePrev = e.angle, e.angle += e.angularVelocity;
        ...
        i.create = function(e) {
            ...
            if (-1 !== o && i.removeCompositeAt(e, o), n)
                for (var s = 0; s < e.composites.length; s++) i.removeComposite(e.composites[s], t, !0);
            return e
            ...
            if (-1 !== o && i.removeBodyAt(e, o), n)
                for (var s = 0; s < e.composites.length; s++) i.removeBody(e.composites[s], t, !0);
            return e
            ...
            if (-1 !== o && i.removeConstraintAt(e, o), n)
                for (var s = 0; s < e.composites.length; s++) i.removeConstraint(e.composites[s], t, !0);
            return e
        ...
        i._motionWakeThreshold = .18, i._motionSleepThreshold = .08, i._minBias = .9, i.update = function(e, t) {
            for (var n = t / s._baseDelta, r = i._motionSleepThreshold, a = 0; a < e.length; a++) {
                var l = e[a],
                    c = o.getSpeed(l),
        ...
        o = [], r = {
            ...
            if (i._overlapAxes(s, t.vertices, e.vertices, t.axes), s.overlap <= 0) return null;
            var o, c, u = n && n.table[l.id(e, t)];
            u ? o = u.collision : ((o = i.create(e, t)).collided = !0, o.bodyA = e.id < t.id ? e : t, o.bodyB = e.id < t.id ? t : e, o.parentA = o.bodyA.parent, o.parentB = o.bodyB.parent), e = o.bodyA, t = o.bodyB, c = r.overlap < s.overlap ? r : s;
            var d = o.normal,
                p = o.supports,
                f = c.axis,
                v = f.x,
            ...
            var m = i._findSupports(e, t, d, 1),
                h = 0;
            if (a.contains(e.vertices, m[0]) && (p[h++] = m[0]), a.contains(e.vertices, m[1]) && (p[h++] = m[1]), h < 2) {
                var g = i._findSupports(t, e, d, -1);
                a.contains(t.vertices, g[0]) && (p[h++] = g[0]), h < 2 && a.contains(t.vertices, g[1]) && (p[h++] = g[1])
            }
            return 0 === h && (p[h++] = m[0]), p.length = h, o
        }, i._overlapAxes = function(e, t, n, i) {
            var o, r, s, a, l, c, u = t.length,
                d = n.length,
                p = t[0].x,
                f = t[0].y,
                v = n[0].x,
            ...
            for (l = 0; l < m; l++) {
                var x = i[l],
                    ...
                    A = w,
                    P = M;
                for (c = 1; c < u; c += 1)(a = t[c].x * b + t[c].y * S) > A ? A = a : a < w && (w = a);
                for (c = 1; c < d; c += 1)(a = n[c].x * b + n[c].y * S) > P ? P = a : a < M && (M = a);
                if ((o = (r = A - M) < (s = P - w) ? r : s) < h && (h = o, g = l, o <= 0)) break
            }
            e.axis = i[g], e.overlap = h
        }, i._projectToAxis = function(e, t, n) {
            for (var i = t[0].x * n.x + t[0].y * n.y, o = i, r = 1; r < t.length; r += 1) {
                var s = t[r].x * n.x + t[r].y * n.y;
                s > o ? o = s : s < i && (i = s)
            }
            e.min = i, e.max = o
        }, i._findSupports = function(e, t, n, i) {
            var r, s, a, l, c, u = t.vertices,
                d = u.length,
                p = e.position.x,
                f = e.position.y,
                v = n.x * i,
                y = n.y * i,
                m = Number.MAX_VALUE;
            for (c = 0; c < d; c += 1)(l = v * (p - (s = u[c]).x) + y * (f - s.y)) < m && (m = l, r = s);
            return m = v * (p - (a = u[(d + r.index - 1) % d]).x) + y * (f - a.y), v * (p - (s = u[(r.index + 1) % d]).x) + y * (f - s.y) < m ? (o[0] = r, o[1] = s, o) : (o[0] = r, o[1] = a, o)
        }
    }, function(e, t, n) {
        var i = {};
        e.exports = i;
        ...
        i._warming = .4, i._torqueDampen = 1, i._minLength = 1e-6, i.create = function(e) {
            ...
            for (o = 0; o < e.length; o += 1) s = !(r = e[o]).bodyA || r.bodyA && r.bodyA.isStatic, a = !r.bodyB || r.bodyB && r.bodyB.isStatic, s || a || i.solve(e[o], n)
            ...
            if (n || o) {
                ...
                if (n && (l = r.add(n.position, s)), o && (c = r.add(o.position, a)), l && c) {
                    ...
                    var p, f, v, y, m, h = (d - e.length) / d,
                        g = e.stiffness >= 1 || 0 === e.length ? e.stiffness * t : e.stiffness * t * t,
                        x = e.damping * t,
                        b = r.mult(u, h * g),
                    ...
                    if (x > 0) {
                        var M = r.create();
                        v = r.div(u, d), m = r.sub(o && r.sub(o.position, o.positionPrev) || M, n && r.sub(n.position, n.positionPrev) || M), y = r.dot(v, m)
                    }
                    n && !n.isStatic && (f = n.inverseMass / S, n.constraintImpulse.x -= b.x * f, n.constraintImpulse.y -= b.y * f, n.position.x -= b.x * f, n.position.y -= b.y * f, x > 0 && (n.positionPrev.x -= x * v.x * y * f, n.positionPrev.y -= x * v.y * y * f), p = r.cross(s, b) / w * i._torqueDampen * n.inverseInertia * (1 - e.angularStiffness), n.constraintImpulse.angle -= p, n.angle -= p), o && !o.isStatic && (f = o.inverseMass / S, o.constraintImpulse.x += b.x * f, o.constraintImpulse.y += b.y * f, o.position.x += b.x * f, o.position.y += b.y * f, x > 0 && (o.positionPrev.x += x * v.x * y * f, o.positionPrev.y += x * v.y * y * f), p = r.cross(a, b) / w * i._torqueDampen * o.inverseInertia * (1 - e.angularStiffness), o.constraintImpulse.angle += p, o.angle += p)
                }
            }
            ...
            for (var t = 0; t < e.length; t++) {
                ...
                if (!(n.isStatic || 0 === c.x && 0 === c.y && 0 === c.angle)) {
                    ...
                    for (var u = 0; u < n.parts.length; u++) {
                        var d = n.parts[u];
                        o.translate(d.vertices, c), u > 0 && (d.position.x += c.x, d.position.y += c.y), 0 !== c.angle && (o.rotate(d.vertices, c.angle, n.position), l.rotate(d.axes, c.angle), u > 0 && r.rotateAbout(d.position, c.angle, n.position, d.position)), a.update(d.bounds, d.vertices, n.velocity)
                    }
        ...
        i.rectangle = function(e, t, n, i, a) {
            ...
            var c, u = n * (a *= .5),
                d = u + (1 - 2 * a) * n,
                p = d + u;
            c = a < .5 ? "L 0 0 L " + u + " " + -i + " L " + d + " " + -i + " L " + p + " 0" : "L 0 0 L " + d + " " + -i + " L " + p + " 0";
            var f = {
            ...
            return l % 2 == 1 && (l += 1), i.polygon(e, t, l, n, r.extend({}, a, o))
            ...
            if (l.chamfer) {
                var h = l.chamfer;
                m.vertices = o.chamfer(m.vertices, h.radius, h.quality, h.qualityMin, h.qualityMax), delete l.chamfer
            }
            return s.create(r.extend({}, m, l))
        }, i.fromVertices = function(e, t, n, i, c, u, d, p) {
            var f, v, y, m, h, g, x, b, S, w, M = r.getDecomp();
            for (f = Boolean(M && M.quickDecomp), i = i || {}, y = [], c = void 0 !== c && c, u = void 0 !== u ? u : .01, d = void 0 !== d ? d : 10, p = void 0 !== p ? p : .01, r.isArray(n[0]) || (n = [n]), S = 0; S < n.length; S += 1)
                if (h = n[S], !(m = o.isConvex(h)) && !f && r.warnOnce("Bodies.fromVertices: Install the 'poly-decomp' library and use Common.setDecomp or provide 'decomp' as a global to decompose concave vertices."), m || !f) h = m ? o.clockwiseSort(h) : o.hull(h), y.push({
                    position: {
                        x: e,
                        y: t
                    },
                    ...
                    M.makeCCW(A), !1 !== u && M.removeCollinearPoints(A, u), !1 !== p && M.removeDuplicatePoints && M.removeDuplicatePoints(A, p);
                    var P = M.quickDecomp(A);
                    for (g = 0; g < P.length; g++) {
                        var B = P[g].map((function(e) {
                            return {
                                x: e[0],
                                y: e[1]
                            }
                        }));
                        d > 0 && o.area(B) < d || y.push({
                            position: o.centre(B),
                            vertices: B
                        })
                    }
                }
            for (g = 0; g < y.length; g++) y[g] = s.create(r.extend(y[g], i));
            if (c)
                for (g = 0; g < y.length; g++) {
                    var C = y[g];
                    for (x = g + 1; x < y.length; x++) {
                        var _ = y[x];
                        if (a.overlaps(C.bounds, _.bounds)) {
                            var k = C.vertices,
                                I = _.vertices;
            ...
            return y.length > 1 ? (v = s.create(r.extend({
                parts: y.slice(0)
            }, i)), s.setPosition(v, {
                x: e,
                y: t
        ...
        i.create = function(e) {
            ...
            var t, n, o = [],
                ...
                c = i.canCollide,
                u = r.collides;
            for (a.sort(i._compareBoundsX), t = 0; t < l; t++) {
                var d = a[t],
                    p = d.bounds,
                    f = d.bounds.max.x,
                    v = d.bounds.max.y,
                ...
                for (n = t + 1; n < l; n++) {
                    var x = a[n];
                    if ((C = x.bounds).min.x > f) break;
                    if (!(v < C.min.y || y > C.max.y) && (!m || !x.isStatic && !x.isSleeping) && c(d.collisionFilter, x.collisionFilter)) {
                        var b = x.parts.length;
                        if (g && 1 === b)(P = u(d, x, s)) && o.push(P);
                        else
                            for (var S = b > 1 ? 1 : 0, w = h > 1 ? 1 : 0; w < h; w++)
                                for (var M = d.parts[w], A = (p = M.bounds, S); A < b; A++) {
                                    var P, B = x.parts[A],
                                        C = B.bounds;
                                    p.min.x > C.max.x || p.max.x < C.min.x || p.max.y < C.min.y || p.min.y > C.max.y || (P = u(M, B, s)) && o.push(P)
                                }
                    }
                }
            }
            ...
            if (!(r in (t = t || {}))) {
                e = i.resolve(e) || e, t[r] = o.map(e.uses || [], (function(t) {
                    ...
                    var r = i.dependencyParse(t),
                        s = i.resolve(t);
                    return s && !i.versionSatisfies(s.version, r.range) ? (o.warn("Plugin.dependencies:", i.toString(s), "does not satisfy", i.toString(r), "used by", i.toString(n) + "."), s._warned = !0, e._warned = !0) : s || (o.warn("Plugin.dependencies:", i.toString(t), "used by", i.toString(n), "could not be resolved."), e._warned = !0), r.name
                }));
        ...
        i.create = function(e) {
            ...
            for (f.isModified && (s.setBodies(v, x), c.setModified(f, !1, !1, !0)), e.enableSleeping && o.update(x, t), i._bodiesApplyGravity(x, e.gravity), t > 0 && i._bodiesUpdate(x, t), u.preSolveAll(x), n = 0; n < e.constraintIterations; n++) u.solveAll(b, t);
            u.postSolveAll(x), v.pairs = e.pairs;
            var S = s.collisions(v);
            a.update(y, S, h), e.enableSleeping && o.afterCollisions(y.list), y.collisionStart.length > 0 && l.trigger(e, "collisionStart", {
            ...
            for (r.postSolvePosition(x), u.preSolveAll(x), n = 0; n < e.constraintIterations; n++) u.solveAll(b, t);
            for (u.postSolveAll(x), r.preSolveVelocity(y.list), n = 0; n < e.velocityIterations; n++) r.solveVelocity(y.list, t);
            return i._bodiesUpdateVelocities(x), y.collisionActive.length > 0 && l.trigger(e, "collisionActive", {
                pairs: y.collisionActive
            }), y.collisionEnd.length > 0 && l.trigger(e, "collisionEnd", {
                pairs: y.collisionEnd
            }), i._bodiesClearForces(x), l.trigger(e, "afterUpdate", g), e.timing.lastElapsed = d.now() - p, e
        }, i.merge = function(e, t) {
            if (d.extend(e, t), t.world) {
                e.world = t.world, i.clear(e);
                for (var n = c.allBodies(e.world), r = 0; r < n.length; r++) {
                    var s = n[r];
                    o.set(s, !1), s.id = d.nextId()
                }
            }
        }, i.clear = function(e) {
        ...
        i._restingThresh = 2, i._restingThreshTangent = Math.sqrt(6), i._positionDampen = .9, i._positionWarming = .8, i._frictionNormalMultiplier = 5, i._frictionMaxStatic = Number.MAX_VALUE, i.preSolvePosition = function(e) {
            ...
            var o, s, a, l, c, u, d, p, f = i._positionDampen * (n || 1),
                v = r.clamp(t / r._baseDelta, 0, 1),
                y = e.length;
            for (o = 0; o < y; o++)(s = e[o]).isActive && !s.isSensor && (l = (a = s.collision).parentA, c = a.parentB, u = a.normal, s.separation = u.x * (c.positionImpulse.x + a.penetration.x - l.positionImpulse.x) + u.y * (c.positionImpulse.y + a.penetration.y - l.positionImpulse.y));
            for (o = 0; o < y; o++)(s = e[o]).isActive && !s.isSensor && (l = (a = s.collision).parentA, c = a.parentB, u = a.normal, p = s.separation - s.slop * v, (l.isStatic || c.isStatic) && (p *= 2), l.isStatic || l.isSleeping || (d = f / l.totalContacts, l.positionImpulse.x += u.x * p * d, l.positionImpulse.y += u.y * p * d), c.isStatic || c.isSleeping || (d = f / c.totalContacts, c.positionImpulse.x -= u.x * p * d, c.positionImpulse.y -= u.y * p * d))
        }, i.postSolvePosition = function(e) {
            for (var t = i._positionWarming, n = e.length, r = o.translate, a = s.update, l = 0; l < n; l++) {
                var c = e[l],
                    u = c.positionImpulse,
                    d = u.x,
                    p = u.y,
                ...
                if (c.totalContacts = 0, 0 !== d || 0 !== p) {
                    for (var v = 0; v < c.parts.length; v++) {
                        var y = c.parts[v];
                        r(y.vertices, u), a(y.bounds, y.vertices, f), y.position.x += d, y.position.y += p
                    }
                ...
                if (o.isActive && !o.isSensor) {
                    ...
                    for (n = 0; n < s; n++) {
                        ...
                        if (0 !== v || 0 !== y) {
                            var m = u.x * v + d.x * y,
                                h = u.y * v + d.y * y;
                            l.isStatic || l.isSleeping || (l.positionPrev.x += m * l.inverseMass, l.positionPrev.y += h * l.inverseMass, l.anglePrev += l.inverseInertia * ((f.x - l.position.x) * h - (f.y - l.position.y) * m)), c.isStatic || c.isSleeping || (c.positionPrev.x -= m * c.inverseMass, c.positionPrev.y -= h * c.inverseMass, c.anglePrev -= c.inverseInertia * ((f.x - c.position.x) * h - (f.y - c.position.y) * m))
                        }
                    }
                }
            }
        }, i.solveVelocity = function(e, t) {
            var n, o, s, a, l = t / r._baseDelta,
                c = l * l * l,
            ...
            for (s = 0; s < v; s++) {
                ...
                if (y.isActive && !y.isSensor) {
                    var m = y.collision,
                        ...
                        B = P.length,
                        C = 1 / B,
                        _ = h.inverseMass + g.inverseMass,
                        k = y.friction * y.frictionStatic * p;
                    for (x.x = h.position.x - h.positionPrev.x, x.y = h.position.y - h.positionPrev.y, b.x = g.position.x - g.positionPrev.x, b.y = g.position.y - g.positionPrev.y, h.angularVelocity = h.angle - h.anglePrev, g.angularVelocity = g.angle - g.anglePrev, a = 0; a < B; a++) {
                        var I = P[a],
                            T = I.vertex,
                            R = T.x - h.position.x,
                            E = T.y - h.position.y,
                            D = T.x - g.position.x,
                            V = T.y - g.position.y,
                            O = x.x - E * h.angularVelocity,
                            L = x.y + R * h.angularVelocity,
                            F = O - (b.x - V * g.angularVelocity),
                            H = L - (b.y + D * g.angularVelocity),
                            W = S * F + w * H,
                            q = M * F + A * H,
                            j = y.separation + W,
                            G = Math.min(j, 1),
                            z = (G = j < 0 ? 0 : G) * k;
                        q < -z || q > z ? (o = q > 0 ? q : -q, (n = y.friction * (q > 0 ? 1 : -1) * c) < -o ? n = -o : n > o && (n = o)) : (n = q, o = f);
                        var U = R * w - E * S,
                            N = D * w - V * S,
                            X = C / (_ + h.inverseInertia * U * U + g.inverseInertia * N * N),
                            Q = (1 + y.restitution) * W * X;
                        if (n *= X, W < u) I.normalImpulse = 0;
                        else {
                        ...
                        var $ = S * Q + M * n,
                            J = w * Q + A * n;
                        h.isStatic || h.isSleeping || (h.positionPrev.x += $ * h.inverseMass, h.positionPrev.y += J * h.inverseMass, h.anglePrev += (R * J - E * $) * h.inverseInertia), g.isStatic || g.isSleeping || (g.positionPrev.x -= $ * g.inverseMass, g.positionPrev.y -= J * g.inverseMass, g.anglePrev -= (D * J - V * $) * g.inverseInertia)
                    }
                }
            }
        }
        ...
        i.create = function(e) {
            ...
            var i, r, s, a, l = e.list,
                ...
                f = e.collisionEnd,
                v = e.collisionActive;
            for (p.length = 0, f.length = 0, v.length = 0, a = 0; a < c; a++) l[a].confirmedActive = !1;
            for (a = 0; a < d; a++)(s = (i = t[a]).pair) ? (s.isActive ? v.push(s) : p.push(s), o.update(s, i, n), s.confirmedActive = !0) : (u[(s = o.create(i, n)).id] = s, p.push(s), l.push(s));
            var y = [];
            for (c = l.length, a = 0; a < c; a++)(s = l[a]).confirmedActive || (o.setActive(s, !1, n), f.push(s), s.collision.bodyA.isSleeping || s.collision.bodyB.isSleeping || y.push(a));
            for (a = 0; a < y.length; a++) s = l[r = y[a] - a], l.splice(r, 1), delete u[s.id]
        }, i.clear = function(e) {
        ...
        i.stack = function(e, t, n, i, r, s, l) {
                ...
                for (var y = 0, m = 0; m < n; m++) {
                    ...
                    if (h) {
                        var g = h.bounds.max.y - h.bounds.min.y,
                            x = h.bounds.max.x - h.bounds.min.x;
                        g > y && (y = g), a.translate(h, {
                            x: .5 * x,
                            y: .5 * g
                        }), d = h.bounds.max.x + r, o.addBody(u, h), c = h, f += 1
                    } else d += r
                }
                p += y + s, d = e
            }
            ...
            for (var c = e.bodies, u = 1; u < c.length; u++) {
                var d = c[u - 1],
                    ...
                    h = s.extend(m, l);
                o.addConstraint(e, r.create(h))
            }
            return e.label += " Chain", e
        }, i.mesh = function(e, t, n, i, a) {
            var l, c, u, d, p, f = e.bodies;
            for (l = 0; l < n; l++) {
                for (c = 1; c < t; c++) u = f[c - 1 + l * t], d = f[c + l * t], o.addConstraint(e, r.create(s.extend({
                    bodyA: u,
                    bodyB: d
                }, a)));
                if (l > 0)
                    for (c = 0; c < t; c++) u = f[c + (l - 1) * t], d = f[c + l * t], o.addConstraint(e, r.create(s.extend({
                        bodyA: u,
                        bodyB: d
                    }, a))), i && c > 0 && (p = f[c - 1 + (l - 1) * t], o.addConstraint(e, r.create(s.extend({
                        bodyA: p,
                        bodyB: d
                    }, a)))), i && c < t - 1 && (p = f[c + 1 + (l - 1) * t], o.addConstraint(e, r.create(s.extend({
                        bodyA: p,
                        bodyB: d
                    }, a))))
            }
            ...
            return i.stack(e, t, n, o, r, s, (function(t, i, s, c, u, d) {
                ...
                if (!(c > p || s < (c = p - c) || s > n - 1 - c)) return 1 === d && a.translate(u, {
                    x: (s + (n % 2 == 1 ? 1 : -1)) * f,
                    y: 0
                }), l(e + (u ? s * f : 0) + s * r, i, s, c, u, d)
            }))
            ...
            return a
        }, c(i, "newtonsCradle", "Composites.newtonsCradle ➤ moved to newtonsCradle example"), i.car = function(e, t, n, i, s) {
            var c = a.nextGroup(!0),
                u = .5 * -n + 20,
                d = .5 * n - 20,
                p = o.create({
            ...
            return o.addBody(p, f), o.addBody(p, v), o.addBody(p, y), o.addConstraint(p, m), o.addConstraint(p, h), p
        }, c(i, "car", "Composites.car ➤ moved to car example"), i.softBody = function(e, t, n, o, r, a, c, u, d, p) {
            d = s.extend({
                inertia: 1 / 0
            }, d), p = s.extend({
                stiffness: .2,
        ...
        i.create = function(e) {
                    ...
                    if (!f.region || v.id !== f.region.id || o) {
                        ...
                        for (s = y.startCol; s <= y.endCol; s++)
                            for (a = y.startRow; a <= y.endRow; a++) {
                                ...
                                var m = s >= v.startCol && s <= v.endCol && a >= v.startRow && a <= v.endRow,
                                    h = s >= f.region.startCol && s <= f.region.endCol && a >= f.region.startRow && a <= f.region.endRow;
                                !m && h && h && l && i._bucketRemoveBody(e, l, f), (f.region === v || m && !h || o) && (l || (l = i._createBucket(d, c)), i._bucketAddBody(e, l, f))
                            }
                        f.region = v, p = !0
                    }
                }
        ...
        }, s(i, "update", "Grid.update ➤ replaced by Matter.Detector"), i.clear = function(e) {
            e.buckets = {}, e.pairs = {}, e.pairsList = []
        }, s(i, "clear", "Grid.clear ➤ replaced by Matter.Detector"), i._regionUnion = function(e, t) {
            ...
            var t, n, i = e.pairs,
                ...
                s = o.length,
                a = [];
            for (n = 0; n < s; n++)(t = i[o[n]])[2] > 0 ? a.push(t) : delete i[o[n]];
            return a
        }
    }, function(e, t, n) {
        var i = {};
        ...
        i.collides = function(e, t) {
            for (var n = [], i = t.length, o = e.bounds, a = r.collides, l = s.overlaps, c = 0; c < i; c++) {
                var u = t[c],
                    d = u.parts.length,
                    p = 1 === d ? 0 : 1;
                if (l(u.bounds, o))
            ...
            r = r || 1e-100;
            for (var s = o.angle(t, n), l = o.magnitude(o.sub(t, n)), c = .5 * (n.x + t.x), u = .5 * (n.y + t.y), d = a.rectangle(c, u, l, r, {
                    angle: s
        ...
        ! function() {
            ...
            "undefined" != typeof window && (e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                ...
                if (l.trigger(e, "beforeRender", M), e.currentBackground !== b && y(e, b), v.globalCompositeOperation = "source-in", v.fillStyle = "transparent", v.fillRect(0, 0, f.width, f.height), v.globalCompositeOperation = "source-over", m.hasBounds) {
                    for (n = 0; n < g.length; n++) {
                        var A = g[n];
                        a.overlaps(A.bounds, e.bounds) && S.push(A)
                    }
                    for (n = 0; n < x.length; n++) {
                        var P = x[n],
                            ...
                            _ = P.pointA,
                            k = P.pointB;
                        B && (_ = c.add(B.position, P.pointA)), C && (k = c.add(C.position, P.pointB)), _ && k && (a.contains(e.bounds, _) || a.contains(e.bounds, k)) && w.push(P)
                    }
                ...
                var n = e.engine,
                    ...
                    m = d(a) / p || 0,
                    h = 1e3 / p || 0;
                t.fillStyle = "#0e0f19", t.fillRect(0, 50, 370, 34), i.status(t, 10, 69, 60, 4, r.length, Math.round(h) + " fps", h / i._goodFps, (function(e) {
                    return r[e] / p - 1
                    ...
                    return c[e] / y - 1
                })), i.status(t, 226, 69, 60, 4, s.length, f.toFixed(2) + " rt", 1 - f / i._goodFps, (function(e) {
                    return s[e] / f - 1
                })), i.status(t, 298, 69, 60, 4, a.length, m.toFixed(2) + " x", m * m * m, (function(e) {
                    return (a[e] / r[e] / m || 0) - 1
                }))
            }, i.status = function(e, t, n, i, o, s, a, l, c) {
                e.strokeStyle = "#888", e.fillStyle = "#444", e.lineWidth = 1, e.fillRect(t, n + 7, i, 1), e.beginPath(), e.moveTo(t, n + 7 - o * r.clamp(.4 * c(0), -2, 2));
                for (var u = 0; u < i; u += 1) e.lineTo(t + u, n + 7 - (u < s ? o * r.clamp(.4 * c(u), -2, 2) : 0));
                e.stroke(), e.fillStyle = "hsl(" + r.clamp(25 + 95 * l, 0, 120) + ",100%,60%)", e.fillRect(t, n - 7, 4, 4), e.font = "12px Arial", e.textBaseline = "middle", e.textAlign = "right", e.fillStyle = "#eee", e.fillText(a, t + i, n - 5)
                ...
                for (var n = t, i = 0; i < e.length; i++) {
                    ...
                    if (o.render.visible && o.pointA && o.pointB) {
                        var s, a, l = o.bodyA,
                            u = o.bodyB;
                        if (s = l ? c.add(l.position, o.pointA) : o.pointA, "pin" === o.render.type) n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.closePath();
                        else {
                            if (a = u ? c.add(u.position, o.pointB) : o.pointB, n.beginPath(), n.moveTo(s.x, s.y), "spring" === o.render.type)
                                for (var d, p = c.sub(a, s), f = c.perp(c.normalise(p)), v = Math.ceil(r.clamp(o.length / 5, 12, 20)), y = 1; y < v; y += 1) d = y % 2 == 0 ? 1 : -1, n.lineTo(s.x + p.x * (y / v) + f.x * d * 4, s.y + p.y * (y / v) + f.y * d * 4);
                            n.lineTo(a.x, a.y)
                        }
                            ...
                            if ((o = i.parts[s]).render.visible) {
                                if (l.showSleeping && i.isSleeping ? a.globalAlpha = .5 * o.render.opacity : 1 !== o.render.opacity && (a.globalAlpha = o.render.opacity), o.render.sprite && o.render.sprite.texture && !l.wireframes) {
                                    var u = o.render.sprite,
                                        d = v(e, u.texture);
                                    a.translate(o.position.x, o.position.y), a.rotate(o.angle), a.drawImage(d, d.width * -u.xOffset * u.xScale, d.height * -u.yOffset * u.yScale, d.width * u.xScale, d.height * u.yScale), a.rotate(-o.angle), a.translate(-o.position.x, -o.position.y)
                                } else {
                ...
                for (l.beginPath(), r = 0; r < t.length; r++)
                    if ((i = t[r]).render.visible)
                        for (a = i.parts.length > 1 ? 1 : 0; a < i.parts.length; a++) {
                            for (o = i.parts[a], l.moveTo(o.vertices[0].x, o.vertices[0].y), s = 1; s < o.vertices.length; s++) !o.vertices[s - 1].isInternal || c ? l.lineTo(o.vertices[s].x, o.vertices[s].y) : l.moveTo(o.vertices[s].x, o.vertices[s].y), o.vertices[s].isInternal && !c && l.moveTo(o.vertices[(s + 1) % o.vertices.length].x, o.vertices[(s + 1) % o.vertices.length].y);
                ...
                for (i = 0; i < t.length; i++) {
                    ...
                    for (r = a.length > 1 ? 1 : 0; r < a.length; r++) {
                        var l = a[r];
                        for (o = 0; o < l.vertices.length; o++) s.fillStyle = "rgba(255,255,255,0.2)", s.fillText(i + "_" + o, l.position.x + .8 * (l.vertices[o].x - l.position.x), l.position.y + .8 * (l.vertices[o].y - l.position.y))
                    }
                }
                    ...
                    if (c.render.visible)
                        if (l.showAxes)
                            for (r = u.length > 1 ? 1 : 0; r < u.length; r++)
                                for (i = u[r], s = 0; s < i.axes.length; s++) {
                                    var d = i.axes[s];
                                    a.moveTo(i.position.x, i.position.y), a.lineTo(i.position.x + 20 * d.x, i.position.y + 20 * d.y)
                                } else
                                    for (r = u.length > 1 ? 1 : 0; r < u.length; r++)
                                        for (i = u[r], s = 0; s < i.axes.length; s++) a.moveTo(i.position.x, i.position.y), a.lineTo((i.vertices[0].x + i.vertices[i.vertices.length - 1].x) / 2, (i.vertices[0].y + i.vertices[i.vertices.length - 1].y) / 2)
                }
                ...
                for (a.beginPath(), r = 0; r < t.length; r++)
                    if ((i = t[r]).render.visible)
                        for (s = 0; s < i.parts.length; s++) o = i.parts[s], a.arc(o.position.x, o.position.y, 3, 0, 2 * Math.PI, !1), a.closePath();
                ...
                for (var r = 0; r < t.length; r++) {
                    var s = t[r];
                    if (s.render.visible) {
                        var a = o.getVelocity(s);
                        i.moveTo(s.position.x, s.position.y), i.lineTo(s.position.x + a.x, s.position.y + a.y)
                    }
                }
                ...
                for (l.wireframes ? a.fillStyle = "rgba(255,255,255,0.7)" : a.fillStyle = "orange", a.fill(), a.beginPath(), r = 0; r < t.length; r++)
                    if ((i = t[r]).isActive && (o = i.collision, i.activeContacts.length > 0)) {
                        ...
                        2 === i.activeContacts.length && (u = (i.activeContacts[0].vertex.x + i.activeContacts[1].vertex.x) / 2, d = (i.activeContacts[0].vertex.y + i.activeContacts[1].vertex.y) / 2), o.bodyB === o.supports[0].body || !0 === o.bodyA.isStatic ? a.moveTo(u - 8 * o.normal.x, d - 8 * o.normal.y) : a.moveTo(u + 8 * o.normal.x, d + 8 * o.normal.y), a.lineTo(u, d)
                    }
                ...
                for (l.beginPath(), a = 0; a < t.length; a++)
                    if ((i = t[a]).isActive) {
                        ...
                        var u = 1;
                        (s = o.bodyB).isStatic || r.isStatic || (u = .5), s.isStatic && (u = 0), l.moveTo(s.position.x, s.position.y), l.lineTo(s.position.x - o.penetration.x * u, s.position.y - o.penetration.y * u), u = 1, s.isStatic || r.isStatic || (u = .5), r.isStatic && (u = 0), l.moveTo(r.position.x, r.position.y), l.lineTo(r.position.x + o.penetration.x * u, r.position.y + o.penetration.y * u)
                    }
        ...
        ! function() {
            ...
            "undefined" != typeof window && (e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame, t = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.msCancelAnimationFrame), e || (e = function(e) {
                ...
                o.trigger(e, "beforeTick", a), e.frameCounter += 1, n - e.counterTimestamp >= 1e3 && (e.fps = e.frameCounter * ((n - e.counterTimestamp) / 1e3), e.counterTimestamp = n, e.frameCounter = 0), o.trigger(e, "tick", a), o.trigger(e, "beforeUpdate", a), r.update(t, i), o.trigger(e, "afterUpdate", a), o.trigger(e, "afterTick", a)
            }, i.stop = function(e) {
                t(e.frameRequestId)
            ...
            for (var t, n, i, o, r, s, a = e.pathSegList, l = 0, c = 0, u = a.numberOfItems, d = 0; d < u; ++d) {
                ...
                if (/[MLHVCSQTA]/.test(f)) "x" in p && (l = p.x), "y" in p && (c = p.y);
                    ...
                    case "v":
                        ...
                        break;
                    case "c":
                        a.replaceItem(e.createSVGPathSegCurvetoCubicAbs(l, c, i, o, r, s), d);
                        break;
                    case "s":
                        a.replaceItem(e.createSVGPathSegCurvetoCubicSmoothAbs(l, c, r, s), d);
                        break;
                    case "q":
                        a.replaceItem(e.createSVGPathSegCurvetoQuadraticAbs(l, c, i, o), d);
                        break;
                    case "t":
...
function(e) {
    ...
    const t = function(e, t) {
            return t = null == t ? e.length - 1 : +t,
                function(n, i) {
                    for (var o = Math.max(arguments.length - t, 0), r = Array(o), s = 0; s < o; s++) r[s] = arguments[s + t];
                    switch (t) {
                        case 0:
    ...
    window.tpDebounce = function(e, i, o) {
        var r, s, a = function(t, n) {
                r = null, n && (s = e.apply(t, n))
            },
            l = t((function(t) {
                if (r && clearTimeout(r), o) {
                    var l = !r;
                    r = setTimeout(a, i), l && (s = e.apply(this, t))
                } else r = n(a, i, this, t);
                return s
            }));
    ...
    class r {
        constructor(t, n) {
            this._defaults = o, this._name = i, this.options = { ...o,
                ...n
            }, this.DOM = {}, this.DOM.element = t, this.DOM.$element = e(t), this.DOM.throwables = this.DOM.element.querySelectorAll("[data-at-throwable-el]"), this.onWindowResize = tpDebounce(this.onWindowResize.bind(this), 250), this.bodies = [], this.init()
        }
        init() {
        ...
        createBodies() {
            this.DOM.throwables.forEach(((e, t) => {
                const n = e.querySelector("span"),
                    ...
                    o = gsap.quickSetter(e, "x", "px"),
                    r = gsap.quickSetter(e, "y", "px"),
                    s = gsap.utils.random(.2 * -Math.PI, .2 * Math.PI),
                    a = gsap.utils.random(i.width / 2, this.width - i.width / 2),
                    l = -i.width - (t * i.height + 10),
                    c = "sharp" === this.options.roundness ? 0 : i.height / 2,
                    u = Matter.Bodies.rectangle(a, l, i.width, i.height, {
                        chamfer: {
                            radius: c
                        },
                        angle: s,
                ...
                this.bodies.push(u), Matter.Composite.add(this.engine.world, [u]), Matter.Events.on(this.runner, "tick", (() => {
                    this.runner.enabled && (n.style.transform = "translate(-50%, -50%) rotate(" + u.angle.toFixed(2) + "rad)", r(u.position.y.toFixed(1)), o(u.position.x.toFixed(1)))
                }))
            }))
        }
        createTopBound() {
        ...
        makeScrollGravity() {
            ...
            Matter.Events.on(this.runner, "tick", (() => {
                const t = document.documentElement.scrollTop - document.documentElement.clientTop,
                    n = t - e;
                this.engine.gravity.y = .7 - gsap.utils.clamp(-2, 4, .1 * n), e = t
            }))
        }
        updateBoundries() {
        ...
        updateBodies() {
            this.DOM.throwables.forEach(((e, t) => {
                const n = this.bodies[t],
                    i = e.getBoundingClientRect(),
                    o = "sharp" === this.options.roundness ? 0 : i.height / 2,
                    r = Matter.Bodies.rectangle(n.position.x, n.position.y, i.width, i.height, {
                        chamfer: {
                            radius: o
                        },
                        angle: n.angle
                    });
                if (Matter.Body.setVertices(n, r.vertices), n.position.y > this.height && Matter.Body.setPosition(n, {
                        y: this.height / 2,
                        x: n.position.x
                    }), n.position.x > this.width) {
                    var s = gsap.utils.random(i.width / 2, this.width - i.width / 2);
        ...
        startRain() {
            this.bodies.forEach(((e, t) => {
                const n = setTimeout((() => {
                    Matter.Body.setStatic(e, !1), clearTimeout(n)
                }), 80 * t)
            }));
            let e = !1;
            Matter.Events.on(this.runner, "tick", (() => {
    ...
    e.fn[i] = function(t) {
        return this.each((function() {
            const n = { ...e(this).data("throwable-options"),
                ...t
            };
            e.data(this, "plugin_" + i) || e.data(this, "plugin_" + i, new r(this, n))
        }))
    }
}(jQuery), jQuery(document).ready((function(e) {
    e("[data-at-throwable-scene]").atThrowable()
}));