    ...
    i.c = {}, i.c.d = t(document), i.c.t = function(t) {
        ...
        this.o = null, this.$ = null, this.i = null, this.g = null, this.v = null, this.cv = null, this.x = 0, this.y = 0, this.w = 0, this.h = 0, this.$c = null, this.c = null, this.t = 0, this.isInit = !1, this.fgColor = null, this.pColor = null, this.dH = null, this.cH = null, this.eH = null, this.rH = null, this.scale = 1, this.relative = !1, this.relativeWidth = !1, this.relativeHeight = !1, this.$div = null, this.run = function() {
            ...
            var h = function(t) {
                ...
                i != s.cv && (s.cH && !1 === s.cH(i) || (s.change(s._validate(i)), s._draw()))
            };
        ...
        i.o.call(this), this.startAngle = null, this.xy = null, this.radius = null, this.lineWidth = null, this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function() {
            ...
            t = this.o.parse(t), !1 !== i && t != this.v && this.rH && !1 === this.rH(t) || (this.cv = this.o.stopper ? s(h(t, this.o.max), this.o.min) : t, this.v = this.cv, this.$.val(this.o.format(this.v)), this._draw())
        }, this.xy2val = function(t, i) {
            var n, e;
            return n = Math.atan2(t - (this.x + this.w2), -(i - this.y - this.w2)) - this.angleOffset, this.o.flip && (n = this.angleArc - n - this.PI2), this.angleArc != this.PI2 && n < 0 && n > -.5 ? n = 0 : n < 0 && (n += this.PI2), e = ~~(.5 + n * (this.o.max - this.o.min) / this.angleArc) + this.o.min, this.o.stopper && (e = s(h(e, this.o.max), this.o.min)), e
            ...
            var i, n, e, a, o = this,
                r = function(t) {
                    ...
                    var e = t.originalEvent,
                        ...
                        r = e.detail || e.wheelDeltaY,
                        l = o._validate(o.o.parse(o.$.val())) + (a > 0 || r > 0 ? o.o.step : a < 0 || r < 0 ? -o.o.step : 0);
            ...
            this.$.bind("keydown", (function(i) {
                var n = i.keyCode;
                if (n >= 96 && n <= 105 && (n = i.keyCode = n - 48), e = parseInt(String.fromCharCode(n)), isNaN(e) && (13 !== n && 8 !== n && 9 !== n && 189 !== n && (190 !== n || o.$.val().match(/\./)) && i.preventDefault(), t.inArray(n, [37, 38, 39, 40]) > -1)) {
                    i.preventDefault();
                    var r = o.o.parse(o.$.val()) + c[n] * l;
                    o.o.stopper && (r = s(h(r, o.o.max), o.o.min)), o.change(r), o._draw(), a = window.setTimeout((function() {
                        l *= 2
                    }), 30)
                }
            })).bind("keyup", (function(t) {
                isNaN(e) ? a && (window.clearTimeout(a), a = null, l = 1, o.val(o.$.val())) : o.$.val() > o.o.max && o.$.val(o.o.max) || o.$.val() < o.o.min && o.$.val(o.o.min)
